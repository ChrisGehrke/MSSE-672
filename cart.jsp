...
if (cart_list != null) {
	HousesDao hDao = new HousesDao(DbCon.getConnection());
	cartProduct = hDao.getCartHouses(cart_list);
	double total = hDao.getTotalCartPrice(cart_list);
